...
public class ExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://casb.bytte.com.co/^^ConsultaProcesoValidacionDocumentoRequest",ConsultaProcesoValidacionDocumentoRequest.class);
        classNames.put("http://casb.bytte.com.co/^^ProcesoAutenticacionLogResponse",ProcesoAutenticacionLogResponse.class);
        classNames.put("http://casb.bytte.com.co/^^ProcesoAutenticacionDocumento",ProcesoAutenticacionDocumento.class);
        classNames.put("http://casb.bytte.com.co/^^ProcesoAutenticacionCapturaHuella",ProcesoAutenticacionCapturaHuella.class);
        classNames.put("http://casb.bytte.com.co/^^DocumentoData",DocumentoData.class);
        classNames.put("http://casb.bytte.com.co/^^ProcesoANIRequest",ProcesoANIRequest.class);
        classNames.put("http://casb.bytte.com.co/^^ProcesoANIResponse",ProcesoANIResponse.class);
        classNames.put("http://casb.bytte.com.co/^^ANIData",ANIData.class);
        classNames.put("http://casb.bytte.com.co/^^ConvertClienteResponse",ConvertClienteResponse.class);
        classNames.put("http://casb.bytte.com.co/^^ValidacionEnrolamientoDocumentoRequest",ValidacionEnrolamientoDocumentoRequest.class);
        classNames.put("http://casb.bytte.com.co/^^RequestBase",RequestBase.class);
        classNames.put("http://casb.bytte.com.co/^^ScoreRequest",ScoreRequest.class);
        classNames.put("http://casb.bytte.com.co/^^ProcesoValidacionDocumentoResponse",ProcesoValidacionDocumentoResponse.class);
        classNames.put("http://casb.bytte.com.co/^^AutenticacionDactilarRequest",AutenticacionDactilarRequest.class);
        classNames.put("http://casb.bytte.com.co/^^UsuarioResponse",UsuarioResponse.class);
        classNames.put("http://casb.bytte.com.co/^^UsuarioEnrolamiento",UsuarioEnrolamiento.class);
        classNames.put("http://casb.bytte.com.co/^^Usuario",Usuario.class);
        classNames.put("http://casb.bytte.com.co/^^ConsultaProcesoValidacionDocumento",ConsultaProcesoValidacionDocumento.class);
        classNames.put("http://casb.bytte.com.co/^^ConsultaProcesoValidacionDocumentoResponse",ConsultaProcesoValidacionDocumentoResponse.class);
        classNames.put("http://casb.bytte.com.co/^^ConsultaProcesoValidacionDocumentoWSQ",ConsultaProcesoValidacionDocumentoWSQ.class);
        classNames.put("http://casb.bytte.com.co/^^ConsultaProcesoValidacionDocumentoWSQResponse",ConsultaProcesoValidacionDocumentoWSQResponse.class);
        classNames.put("http://casb.bytte.com.co/^^ProcesoConsultaANI",ProcesoConsultaANI.class);
        classNames.put("http://casb.bytte.com.co/^^ProcesoConsultaANIResponse",ProcesoConsultaANIResponse.class);
        classNames.put("http://casb.bytte.com.co/^^ConversionCodigodeBarras",ConversionCodigodeBarras.class);
        classNames.put("http://casb.bytte.com.co/^^ConversionCodigodeBarrasResponse",ConversionCodigodeBarrasResponse.class);
        classNames.put("http://casb.bytte.com.co/^^ValidacionEnrolamientoDocumento",ValidacionEnrolamientoDocumento.class);
        classNames.put("http://casb.bytte.com.co/^^ValidacionEnrolamientoDocumentoResponse",ValidacionEnrolamientoDocumentoResponse.class);
        classNames.put("http://casb.bytte.com.co/^^AutenticacionDactilar",AutenticacionDactilar.class);
        classNames.put("http://casb.bytte.com.co/^^AutenticacionDactilarResponse",AutenticacionDactilarResponse.class);
        classNames.put("http://casb.bytte.com.co/^^ConsultaUsuario",ConsultaUsuario.class);
        classNames.put("http://casb.bytte.com.co/^^ConsultaUsuarioResponse",ConsultaUsuarioResponse.class);
        classNames.put("http://www.bytte.com.co/^^Response",Response.class);
        classNames.put("http://www.bytte.com.co/^^ANIResponse",ANIResponse.class);
        classNames.put("http://casb.bytte.com.co/^^ArrayOfProcesoAutenticacionCapturaHuella",ArrayOfProcesoAutenticacionCapturaHuella.class);
    } 
