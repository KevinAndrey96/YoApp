...
class EscaneoOk : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_preutilizacion)

        val cedula=intent.getStringExtra(AppConstants.DNI_OBJECT_NAME).toString()
        documento=cedula

        getAvailableAmountForClient()

        imgEscaneoOk.setOnClickListener {
            val intent2 = Intent(this, ResultCapture::class.java)

            intent2.putExtra(AppConstants.DNI_OBJECT_NAME, ""+cedula)
            intent2.putExtra(AppConstants.IDP_OBJECT_NAME, ""+idperiodo)
                                                                                            ...
                                                                                            if(searchDataresponse != null){
                                                                                                ...
                                                                                                mHandler.post{
                                                                                                    run {
                                                                                                        ...
                                                                                                        Logger.d("El periodo es"+periodo)
                                                                                                        val intent2 = Intent(this@EscaneoOk, ResultCapture::class.java)
                                                                                                        intent2.putExtra(AppConstants.DNI_OBJECT_NAME, ""+documento)
                                                                                                        intent2.putExtra(AppConstants.IDP_OBJECT_NAME, ""+idperiodo)
                                                                                                        startActivity(intent2)
                                                                                                        finish()
